<script lang="ts">
  ...
  async function handleLogin() {
    ...
    setTimeout(() => {
      if (email === "admin@regula.com" && password === "123456") {
        goto('/home');
      } else {
...
<div class="flex items-center justify-center min-h-screen bg-gradient-to-br from-gray-100 to-emerald-100 p-4">
  ...
  <div class="w-full max-w-md p-8 space-y-8 bg-white/70 backdrop-blur-xl rounded-2xl shadow-2xl border border-white/20">
    ...
    <div class="text-center">
      ...
      <h1 class="text-3xl font-bold text-gray-900">Regula System</h1>
    ...
    <form class="space-y-6" on:submit|preventDefault={handleLogin}>
      ...
      <div>
        ...
        <div class="relative mt-1">
          ...
          <input id="email" type="email" bind:value={email} required class="pl-10 block w-full px-4 py-2.5 text-gray-800 bg-white/50 border border-gray-300 rounded-lg focus:border-emerald-500 focus:ring-emerald-500" placeholder="username" />
        </div>
      </div>
